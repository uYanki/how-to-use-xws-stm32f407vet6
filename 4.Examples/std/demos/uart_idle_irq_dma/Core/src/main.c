...
#define DMA_Flags(stream)    (DMA_FLAG_TCIF##stream)
...
#define USART_TX_DMA_CLKEN
#define USART_TX_DMA_CLK
#define USART_TX_DMA_CHANNEL
#define USART_TX_DMA_STREAM
#define USART_TX_DMA_FLAG

#define USART_RX_DMA_CLKEN
#define USART_RX_DMA_CLK
#define USART_RX_DMA_CHANNEL
#define USART_RX_DMA_STREAM
#define USART_RX_DMA_FLAG
...
#define USART_TXBUF_ADDR m_txbuf
