    ...
    {                                                                                                                          \
        ...
        &NODE_PREFIX##_bDeviceNodeId,     /* bDeviceNodeId */                                                                  \
            ...
            _heartbeatError,                        /* heartbeatError */                                                       \
                                                                                                                               \
            {REPEAT_NMT_MAX_NODE_ID_TIMES(NMTable_Initializer)}, /* is  well initialized at "Unknown_state". Is it ok ? (FD)*/ \
                                                                                                                               \
            /* NMT-nodeguarding */                                                                                             \
            ...
            &NODE_PREFIX##_obj1014, /* error_cobid */                         /* error_data: structure s_errors */             \
            {                                                                                                                  \
